document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      privacyDesc1: "Tus imágenes se procesan en tu dispositivo y nunca se suben a un servidor. El historial se guarda localmente en la base de datos de tu navegador. <br>Si tienes dudas sobre la privacidad, puedes consultar nuestra política completa en el siguiente <a href='https://chococreativo.com.co/politica-privacidad'>enlace</a>.</br>",
    ...
    en: {
      ...
      privacyDesc1: "Your images are processed on your device and never uploaded to a server. The history is saved locally in your browser's database. <br>If you have any questions about privacy, you can consult our full policy at the following <a href='https://chococreativo.com.co/politica-privacidad'>link</a>.</br>",
